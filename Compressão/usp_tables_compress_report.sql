...
If Object_ID('usp_tables_compress_report', 'P') Is Not Null
        Drop Procedure usp_tables_compress_report
go
 
CREATE PROCEDURE usp_tables_compress_report (@compress_method char(4), @in_table_name varchar(50) = null)
AS 
SET NOCOUNT ON
BEGIN
...
AND (TABLE_NAME = @in_table_name or @in_table_name is null)
OPEN c_sch_tb_crs
...
Grant Execute On dbo.usp_tables_compress_report To Public
go
Grant Execute On dbo.usp_tables_compress_report To Sistema
go
