...
exec @rc = sp_trace_create @TraceID output, 0, N'E:\MSSQL10_50.MSSQLSERVER\MSSQL\Log\Trace\Signa\Duration', @maxfilesize, @stoptime = @TraceEndDateTime
if (@rc != 0) goto error
