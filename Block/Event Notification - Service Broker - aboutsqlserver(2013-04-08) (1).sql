...
alter procedure [dbo].[SB_BlockedProcessReport_Activation]
		...
		begin try
			begin tran
				...
				(
					...
					from Ecargo.dbo.BlockedProcessNotificationQueue
				), timeout 10000
...
select * 
from ECARGO.dbo.syseventqueue
go

select * 
from BlockedProcessesInfo
...
select * from EventMonitoring.dbo.BlockedProcessesInfo
go



[SB_BlockedProcessReport_Activation]