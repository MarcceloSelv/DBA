...
DECLARE @COLLATE_DESTINO VARCHAR(100) = 'Latin1_General_CI_AS'
...
GO
PRINT 'ALTER DATABASE [SCHENKER] SET SINGLE_USER WITH ROLLBACK IMMEDIATE' + CHAR(13) + CHAR(10) + 'GO' + CHAR(13) + CHAR(10)

PRINT 'ALTER DATABASE [SCHENKER] COLLATE Latin1_General_CI_AS' + CHAR(13) + CHAR(10) + 'GO' + CHAR(13) + CHAR(10)

PRINT 'ALTER DATABASE [SCHENKER] SET MULTI_USER WITH ROLLBACK IMMEDIATE' + CHAR(13) + CHAR(10) + 'GO' + CHAR(13) + CHAR(10)
GO


Declare @TableName Varchar(300),
	@CollationName Varchar(50) = 'Latin1_General_CI_AS',
...
DECLARE @COLLATE_DESTINO VARCHAR(100) = 'Latin1_General_CI_AS1'
